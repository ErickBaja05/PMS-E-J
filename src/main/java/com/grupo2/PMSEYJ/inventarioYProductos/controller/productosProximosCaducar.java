...
public class productosProximosCaducar implements Initializable {

    @FXML
    private Button brnDescargarReporte;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        FontIcon icon5 = new FontIcon("fa-file-excel-o");
        icon5.getStyleClass().add("excelIcon");
        ...
        lblIconExcel.setText(null);
        lblIconExcel.setGraphic(icon5);
