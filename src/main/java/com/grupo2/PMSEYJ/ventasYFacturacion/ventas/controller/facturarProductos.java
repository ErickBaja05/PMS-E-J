...
public class facturarProductos implements Initializable {
...
// Cambiar cursor al pasar el mouse
    ...
    private void terminarFacturacion(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ventasYFacturacion/ventas/fxml/completarFacturacion.fxml"));
        Parent root = loader.load();
        NavigationUtil.openNewWindow(event,root,"Terminar Facturacion");
